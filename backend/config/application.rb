...
module Backend
  class Application < Rails::Application
    ...
    # so PostgreSQL-specific DDL (partial indexes, FK on_delete rules) is captured faithfully.
    config.active_record.schema_format = :sql

    # Generators: RSpec specs + FactoryBot factories, no view/helper/routing specs.
